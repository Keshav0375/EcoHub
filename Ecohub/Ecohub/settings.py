...
# Security settings
SECRET_KEY = config('SECRET_KEY', default='django-insecure-%s^7&idqd^**82go*&=h80@!)v@^709oa%$o2quj*+o6)l_9$z')
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='ecohub_db'),
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_RATES': {
        'anon': '100/hour',
        'user': '1000/hour',
        'vendor': '2000/hour',  # Higher rate for vendor API calls
    }
}
